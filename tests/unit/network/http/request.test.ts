...
import {getMockedConnection} from "../common/utils.js";
...
describe("Request", () => {
    ...
    describe("parseRequest()", () => {
        ...
        test("should throw when http method is invalid", () => {
            const rawRequest = Buffer.from("METHOD /user/messages HTTP/1.1\r\nHost: example.com");
    ...
    describe("getReader()", () => {
        ...
        test("should return fixed body reader when content-length is set", () => {
            ...
            const reader = getReader(getMockedConnection(), new DynamicBuffer(), request);
